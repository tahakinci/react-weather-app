...
const WeatherTab = ({ countryData }) => {
  ...
  async function fetchHourlyWeather() {
    ...
    const json = await res.json();
    setHourlyWeather(json.list); // data objet olarak geldiğinden ve map kullanmadığımda data henüz gelmeden forecat cmponentinde işlem yapmaya çalıştığımdan hata alıyordum
  }
